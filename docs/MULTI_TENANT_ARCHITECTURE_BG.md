...
Мулти-тенант архитектурата на Barasurya ERP позволява на една инсталация на системата да обслужва множество организации (тенанти), като същевременно гарантира пълна изолация на данните, персонализирани настройки и сигурност. Всяка организация работи в независима среда със собствени данни, конфигурации и потребители. Архитектурата е имплементирана с UUID-first дизайн и модерни FastAPI patterns.
